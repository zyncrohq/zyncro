...
> `@zyncro/mcp` Model Context Protocol server is currently in active development.  
> For web integrations and calendar booking widgets, check out the production-ready [`@zyncro/embed`](../zyncro-embed) package.
